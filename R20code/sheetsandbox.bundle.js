...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  __webpack_require__.r(__webpack_exports__);
  /* harmony export */ __webpack_require__.d(__webpack_exports__, {
  /* harmony export */   "default": () => (/* binding */ JqueryShim)
  /* harmony export */ });
  /* harmony import */ var _util_generateUUID__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../util/generateUUID */ "../util/generateUUID.js");
  ...
  class JqueryShim {
    ...
    on(event, callback) {
      ...
      const requestId = (0,_util_generateUUID__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  /***/ "./sheet_sandbox/sandboxMessageHandler.js":
  /*!************************************************!*\
    !*** ./sheet_sandbox/sandboxMessageHandler.js ***!
    \************************************************/
  /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  /**
   * Handle callbacks for jQuery functions
   *
   * @param {string} requestId - The unique id to find the correct callback to execute
   * @param {object} data - The data to be passed to the callback
   */
  const jqueryTrigger = (requestId, data) => {
    if (workerGlobals.registeredCallbacks[requestId]) {
      workerGlobals.registeredCallbacks[requestId](data);
    }
  };
  
  /**
   * Generates a message handler function for sheetworker messages sent via ports
   * @param {Object} globals - The sandboxes global variables
   * @returns {Function} - the message handler function
   */
  const sandboxMessageHandler = (globals) => {
    workerGlobals = globals;
    return (event) => {
      const request = event.data;
  
      if (request.activeCharacterId) workerGlobals.activeCharacterId = request.activeCharacterId;
  
      try {
        switch (request.type) {
          case 'jqueryTrigger':
            jqueryTrigger(request.id, request.data);
            break;
          default:
            break;
        }
      ...
      if (request.activeCharacterId) workerGlobals.activeCharacterId = false;
    };
  };
  
  /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sandboxMessageHandler);
  
  
  /***/ }),
  
  /***/ "./sheet_sandbox/underscore.js":
  /*!*************************************!*\
    !*** ./sheet_sandbox/underscore.js ***!
    \*************************************/
  /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  /* harmony export */   "escape": () => (/* binding */ _escape),
  ...
  /* harmony export */   "isArguments": () => (/* binding */ isArguments$1),
  /* harmony export */   "isArray": () => (/* binding */ isArray),
  /* harmony export */   "isArrayBuffer": () => (/* binding */ isArrayBuffer),
  /* harmony export */   "isBoolean": () => (/* binding */ isBoolean),
  /* harmony export */   "isDataView": () => (/* binding */ isDataView$1),
  /* harmony export */   "isDate": () => (/* binding */ isDate),
  /* harmony export */   "isElement": () => (/* binding */ isElement),
  /* harmony export */   "isEmpty": () => (/* binding */ isEmpty),
  /* harmony export */   "isEqual": () => (/* binding */ isEqual),
  /* harmony export */   "isError": () => (/* binding */ isError),
  /* harmony export */   "isFinite": () => (/* binding */ isFinite$1),
  /* harmony export */   "isFunction": () => (/* binding */ isFunction$1),
  ...
  /* harmony export */   "isTypedArray": () => (/* binding */ isTypedArray$1),
  ...
  /* harmony export */   "toPath": () => (/* binding */ toPath$1),
  /* harmony export */   "transpose": () => (/* binding */ unzip),
  /* harmony export */   "unescape": () => (/* binding */ _unescape),
  ...
  (() => {
  /*!*********************************************!*\
    !*** ./sheet_sandbox/sheetsandboxworker.js ***!
    \*********************************************/
  __webpack_require__.r(__webpack_exports__);
  /* harmony import */ var _underscore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./underscore */ "./sheet_sandbox/underscore.js");
  /* harmony import */ var _jqueryShim__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jqueryShim */ "./sheet_sandbox/jqueryShim.js");
  /* harmony import */ var _sandboxMessageHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sandboxMessageHandler */ "./sheet_sandbox/sandboxMessageHandler.js");
  /* harmony import */ var _util_generateUUID__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../util/generateUUID */ "../util/generateUUID.js");
    ...
    const messageHandler = function (event) {
      ...
      try {
        switch (request.type) {
          case 'preparePort':
            [port2] = event.ports;
            port2.onmessage = (0,_sandboxMessageHandler__WEBPACK_IMPORTED_MODULE_2__["default"])(workerGlobals);
            break;
          case 'eval':
  ...
  }(self, eval, _underscore__WEBPACK_IMPORTED_MODULE_0__["default"], _util_generateUUID__WEBPACK_IMPORTED_MODULE_3__["default"], _jqueryShim__WEBPACK_IMPORTED_MODULE_1__["default"]));
